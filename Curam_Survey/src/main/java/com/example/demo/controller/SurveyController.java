...
public class SurveyController {
	...
	public ResponseEntity<surveyList> createSurvey(@RequestBody surveyList surveyRequest) {
	    ...
	    // Convert questions array to JSON string (if it's not already a String)
	    if (surveyRequest.getQuestionsConfigured() instanceof List) {
	        try {
	            String questionsJson = objectMapper.writeValueAsString(surveyRequest.getQuestionsConfigured());
	            surveyRequest.setQuestionsConfigured(questionsJson);
	        } catch (Exception e) {
